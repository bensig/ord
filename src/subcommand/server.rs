use {
  ...
  super::*,
  crate::{templates::inscription::CharmsExtendedJson,
    templates::inscription::InscriptionExtendedJson
    },
    templates::{
  ...
  pub fn run(self, settings: Settings, index: Arc<Index>, handle: Handle) -> SubcommandResult {
    Runtime::new()?.block_on(async {
      ...
      let router = Router::new()
        ...
        .route(
          "/e/inscription/:inscription_query",
          get(Self::inscription_extended),
        )
